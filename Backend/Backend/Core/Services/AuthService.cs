...
namespace Backend.Core.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager = null, ILogService logService = null, IConfiguration configuration = null)
        {
        ...
        public async Task<GeneralServiceResponseDto> SeedRolesAsync()
        {
            ...
            bool isManagerExists = await _roleManager.RoleExistsAsync(StaticUserRoles.MANAGER);
        ...
        public async Task<GeneralServiceResponseDto> UpdateRoleAsync(ClaimsPrincipal User, UpdateRoles updateRoleDto)
        {
